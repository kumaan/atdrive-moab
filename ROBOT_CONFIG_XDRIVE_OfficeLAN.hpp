...
#define _MOAB_IP_ADDRESS "192.168.1.200"
#define _NETMASK "255.255.255.0"
#define _DEFUALT_GATEWAY "192.168.1.1"
#define _BROADCAST_IP_ADDRESS "192.168.1.255"
#define _AUTOPILOT_IP_ADDRESS "192.168.1.3"
